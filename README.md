...
## ✈️ Mission Profile
This tool bridges the gap between modern flight planning software (Excel, Google Earth, ForeFlight) and the Genesys Aerosystems FMS. It ensures that your custom waypoint lists are formatted correctly for seamless upload via EFIS mission cards.



## 🛠 Features
* **Universal Import:** Supports `.dat` (binary), `.csv` (spreadsheet), `.txt` (tab-separated), and `.kml` (Google Earth).
...
* **Night Flight Ready:** Default Dark Mode interface optimized for cockpit use.
